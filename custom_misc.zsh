...
function customCommands(){
	grep function ~/.oh-my-zsh/custom/gitextension.zsh | sed -e's/\s*function\s*//' | cut -f1 -d"(" ;
	grep function ~/.oh-my-zsh/custom/local_setup.zsh | sed -e's/\s*function\s*//' | cut -f1 -d"(" ;
	grep function ~/.oh-my-zsh/custom/custom_misc.zsh | sed -e's/\s*function\s*//' | cut -f1 -d"(" ;
	grep function ~/.oh-my-zsh/custom/personal.zsh | sed -e's/\s*function\s*//' | cut -f1 -d"(" ;
